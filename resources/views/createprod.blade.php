                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post"  action="{{route('createprod')}}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <label for="year" class="col-md-4 col-form-label text-md-end">Дата выхода
                                    продукта</label>

                                <div class="col-md-6">
                                    <input class="form-control" id="year_of_production" type="text"
                                           name="year" required autofocus>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="country" class="col-md-4 col-form-label text-md-end">Страна
                                    производитель</label>
